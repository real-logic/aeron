...
constexpr const char RX_TIMESTAMP_OFFSET_PARAM_NAME[] = "rx-ts-offset";
constexpr const char RECEIVE_TIMESTAMP_OFFSET_PARAM_NAME[] = "rcv-ts-offset";
constexpr const char SEND_TIMESTAMP_OFFSET_PARAM_NAME[] = "snd-ts-offset";
