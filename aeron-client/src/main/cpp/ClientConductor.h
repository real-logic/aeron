...
public:
    ...
    void releaseSubscription(std::int64_t registrationId, Image::list_t *imageList);
...
protected:
    ...
    void lingerResource(long long nowMs, Image::list_t *imageList);

    void lingerAllResources(long long nowMs, Image::list_t *imageList);
