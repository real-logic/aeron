 ...
 */
@FunctionalInterface
public interface ControlledRawBlockHandler
{
    /**
     * Notification of an available block of fragments.
     *
     * <b>Note:</b> the return value must fall on an aligned message boundary.
     *
     ...
     * @return number of bytes handled and to move the next poll position by.
     */
    int onBlock(
