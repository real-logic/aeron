 ...
 * <p>
 * Each stream managed by the MediaDriver will be sampled and a line of text
...
public final class StreamStat
{
        ...
        counters.forEach(
            (counterId, typeId, keyBuffer, label) ->
            {
                if ((typeId >= DRIVER_PUBLISHER_LIMIT_TYPE_ID && typeId <= DRIVER_RECEIVER_POS_TYPE_ID) ||
                    typeId == DRIVER_SENDER_LIMIT_TYPE_ID || typeId == DRIVER_PUBLISHER_POS_TYPE_ID)
                {
                    ...
                    if (uriIndex >= 0)
                    {
                        ...
                        if (DRIVER_SUBSCRIBER_POSITION_TYPE_ID == typeId &&
    ...
    public int print(final PrintStream out)
    {
        ...
        for (final Map.Entry<StreamCompositeKey, List<StreamPosition>> entry : streams.entrySet())
        {
            ...
            for (final StreamPosition streamPosition : entry.getValue())
            {
                builder
                    .append(' ')
                    .append(CounterLabelNameDescriptor.labelName(streamPosition.typeId()))
    ...
    public static final class StreamCompositeKey
    {
        ...
        /**
         * The full channel as a URI.
         *
         * @return fullChannel as a URI.
         */
        ...
        /**
         * Set the full channel as a URI.
         *
         * @param fullChannel the full channel passed as a URI.
         */
        public void fullChannel(final String fullChannel)
        {
