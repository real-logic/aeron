...
class CExclusiveTermAppenderTest : public testing::Test
{
public:
    CExclusiveTermAppenderTest() :
...
TEST_F(CExclusiveTermAppenderTest, shouldAppendFrameToEmptyLog)
{
    ...
    *m_term_tail_counter = packRawTail(TERM_ID, tail);
    ...
    const int32_t resultingOffset = aeron_exclusive_term_appender_append_unfragmented_message(
        &m_term_buffer,
        m_term_tail_counter,
        tail,
        msgBuffer,
...
TEST_F(CExclusiveTermAppenderTest, shouldAppendFrameTwiceToLog)
{
    uint8_t msgBuffer[SRC_BUFFER_CAPACITY];
    const int32_t msgLength = 20;
    const int32_t frameLength = msgLength + AERON_DATA_HEADER_LENGTH;
...
TEST_F(CExclusiveTermAppenderTest, shouldPadLogWhenAppendingWithInsufficientRemainingCapacity)
{
    uint8_t msgBuffer[SRC_BUFFER_CAPACITY];
...
TEST_F(CExclusiveTermAppenderTest, shouldFragmentMessageOverTwoFrames)
{
    uint8_t msgBuffer[SRC_BUFFER_CAPACITY];
    ...
    *m_term_tail_counter = packRawTail(TERM_ID, tail);
    ...
    resultingOffset = aeron_exclusive_term_appender_append_fragmented_message(
        &m_term_buffer,
        m_term_tail_counter,
        tail,
        msgBuffer,
...
TEST_F(CExclusiveTermAppenderTest, shouldClaimRegionForZeroCopyEncoding)
{
    const int32_t msgLength = 20;
    const int32_t frameLength = msgLength + AERON_DATA_HEADER_LENGTH;
    const int64_t alignedFrameLength = AERON_ALIGN(frameLength, AERON_LOGBUFFER_FRAME_ALIGNMENT);
    ...
    *m_term_tail_counter = packRawTail(TERM_ID, tail);
    ...
    const int32_t resultingOffset = aeron_exclusive_term_appender_claim(
        &m_term_buffer,
        m_term_tail_counter,
        tail,
        msgLength,
...
TEST_F(CExclusiveTermAppenderTest, shouldAppendUnfragmentedFromVectorsToEmptyLog)
{
    ...
    *m_term_tail_counter = packRawTail(TERM_ID, tail);
    ...
    const int32_t resultingOffset = aeron_exclusive_term_appender_append_unfragmented_messagev(
        &m_term_buffer,
        m_term_tail_counter,
        tail,
        iov,
...
TEST_F(CExclusiveTermAppenderTest, shouldAppendFragmentedFromVectorsToEmptyLog)
{
    ...
    *m_term_tail_counter = packRawTail(TERM_ID, tail);
    ...
    resultingOffset = aeron_exclusive_term_appender_append_fragmented_messagev(
        &m_term_buffer,
        m_term_tail_counter,
        tail,
        iov,
