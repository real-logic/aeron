...
public class ConsensusPos
{
     ...
     *
     * @param aeron        to allocated the counter.
     ...
     * @param countersReader to search within.
     * @param counterId      for the active consensus position.
     * @return the beginning position if found otherwise {@link #NULL_COUNTER_ID}.
     */
     ...
     * @param countersReader to search within.
     * @param counterId      for the active consensus position.
     * @return the beginning message index if found otherwise {@link #NULL_COUNTER_ID}.
     */
