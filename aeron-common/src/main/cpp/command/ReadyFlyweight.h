...
{
    virtual std::int32_t bufferOffset(std::int32_t index) = 0;
    virtual concrete_t& bufferOffset(std::int32_t index, std::int32_t value) = 0;
    virtual std::int32_t bufferLength(std::int32_t index) = 0;
    virtual concrete_t&  bufferLength(std::int32_t index, std::int32_t value) = 0;
    virtual std::string location(std::int32_t index) = 0;
    virtual concrete_t& location(std::int32_t index, String value) = 0;
