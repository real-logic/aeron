    ...
    aeron_system_counters_t *system_counters)
{
    ...
    *publication = NULL;
    ...
    _pub->log_file_name_length = aeron_network_publication_location(
    ...
    {
        aeron_set_err(aeron_errcode(), "error mapping network raw log %s: %s", _pub->log_file_name, aeron_errmsg());
        aeron_free(_pub);
        return -1;
    }
