    ...
    aeron_network_publication_t *publication, int32_t term_id, int32_t term_offset, int32_t length)
{
    aeron_retransmit_handler_on_nak(
        ...
        aeron_clock_now(publication->nano_clock),
...
{
    const int64_t time_ns = aeron_clock_now(publication->nano_clock);
...
void aeron_network_publication_decref(void *clientd)
{
    ...
    if (0 == ref_count)
    {
        ...
        publication->conductor_fields.time_of_last_activity_ns = aeron_clock_now(publication->nano_clock);
