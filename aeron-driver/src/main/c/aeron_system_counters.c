...
static aeron_system_counter_t system_counters[] =
    {
        ...
        { "Errors: version=" AERON_DRIVER_VERSION " commit=" AERON_DRIVER_GIT_SHA, AERON_SYSTEM_COUNTER_ERRORS },
        ...
        { "Aeron software: version=" AERON_DRIVER_VERSION " commit=" AERON_DRIVER_GIT_SHA, AERON_SYSTEM_COUNTER_AERON_VERSION },
