...
inline bool aeron_udp_channel_is_rx_timestamping(aeron_udp_channel_t *channel)
{
    return AERON_UDP_CHANNEL_RESERVED_VALUE_OFFSET == channel->rx_timestamp_offset ||
        0 <= channel->rx_timestamp_offset;
}
