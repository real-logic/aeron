...
public class SharedLog implements DriverManagedResourceProvider
{
        ...
        final RawLog rawLog)
    {
        ...
        this.driverManagedResource = new SharedLogDriverManagedResource();
    ...
    public int updatePublishersLimit()
    {
        ...
        final boolean hasSubscribers = 0 < subscriberPositions.size();
        int workCount = 0;

        final long candidatePublisherLimit = hasSubscribers ? minSubscriberPosition + termWindowLength : 0L;
