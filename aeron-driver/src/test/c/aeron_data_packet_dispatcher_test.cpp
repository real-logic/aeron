...
protected:
    virtual void SetUp()
    {
        ...
        aeron_data_packet_dispatcher_init(&m_dispatcher, &m_conductor_proxy, &m_receiver);
        ...
        m_context->congestion_control_supplier_func(
            ...
            &m_control_address, &m_source_address, m_context, &m_counters_manager);
    };
    ...
    virtual void TearDown()
    {
        ...
        aeron_data_packet_dispatcher_close(&m_dispatcher);
    ...
    aeron_publication_image_t *createImage(int32_t stream_id, int32_t session_id)
    {
        ...
        if (aeron_publication_image_create(
            ...
            &m_control_address, &m_source_address,
    ...
    struct sockaddr_storage m_control_address;
    struct sockaddr_storage m_source_address;
