...
void countTimesAsSizeT(int32_t msg_type_id, const void *msg, size_t length, void *clientd)
{
...
TEST(SpscRbConcurrentTest, shouldExchangeMessages)
{
    ...
    {
        const size_t readCount = aeron_spsc_rb_read(&rb, spsc_rb_concurrent_handler, &counts, 1);
