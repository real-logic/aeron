...
class RetransmitHandlerTest
{
    ...
    private RetransmitHandler handler = RetransmitHandler.acquire(
    ...
    {
        return RetransmitHandler.acquire(
            () -> currentTime, invalidPackets, ZERO_DELAY_GENERATOR, LINGER_GENERATOR, true);
    }
