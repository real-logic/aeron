...
consensusEndpoint='localhost:9104', logEndpoint='localhost:9105', transferEndpoint='localhost:9106',
...
consensusEndpoint='localhost:9204', logEndpoint='localhost:9205', transferEndpoint='localhost:9206',
