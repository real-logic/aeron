 ...
 *     {@link AeronArchive.Configuration#CONTROL_STREAM_ID_DEFAULT}</li>
 ...
 *     <li>{@link AeronArchive.Configuration#CONTROL_CHANNEL_PROP_NAME} - required, specifies control request channel
 *     for connecting to the destination Archive.</li>
 *     <li>{@link AeronArchive.Configuration#CONTROL_STREAM_ID_PROP_NAME} - optional, specifies control request stream
 *     id for connecting to the destination Archive. Defaults to {@link AeronArchive.Configuration#CONTROL_STREAM_ID_DEFAULT}.
 *     </li>
 *     <li>{@link AeronArchive.Configuration#CONTROL_RESPONSE_CHANNEL_PROP_NAME} - required, specifies control response
 *     channel for receiving responses from the destination Archive.</li>
 *     <li>{@link AeronArchive.Configuration#CONTROL_RESPONSE_STREAM_ID_PROP_NAME} - optional, specifies control
...
public final class RecordingReplicator
{
     ...
     *                                  replaced. If set as {@link Aeron#NULL_VALUE} in which case a
     ...
     *                                  {@link io.aeron.archive.Archive.Context#replicationChannel()} of the destination
     *                                  Archive will be used.
     * @throws NullPointerException     if any of the required properties are not set.
     * @throws IllegalArgumentException if {@link AeronArchive.Context#recordingSignalConsumer()} is not set.
     * @throws ClassCastException       if {@link AeronArchive.Context#recordingSignalConsumer()} is not an instance of
     *                                  the {@link RecordingSignalCapture} class.
     */
