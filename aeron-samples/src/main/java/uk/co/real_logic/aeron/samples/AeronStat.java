...
/**
 * Application to print out status counters and labels
 * A command and control memory file is maintained by media driver in shared memory.
 * This application reads the the cnc file and prints the statistics counters.
...
public class AeronStat
{
    public static void main(final String[] args) throws Exception
    {
        ...
        // Create a new counter Manager over the labels and the values buffer
