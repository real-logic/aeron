...
public class UriSpecifiedFlowControlTest
{
    ...
    private static final String URI_WITH_MAX_FLOW_CONTROL = MULTICAST_URI + "|fc=max";
    ...
    public void shouldSpinUpAndShutdown()
    {
        assertTimeoutPreemptively(ofSeconds(10), () ->
        {
            ...
            publication = clientA.addPublication(URI_WITH_MIN_FLOW_CONTROL, STREAM_ID);
    ...
    public void shouldTimeoutImageWhenBehindForTooLongWithMaxMulticastFlowControlStrategy()
    {
        assertTimeoutPreemptively(ofSeconds(20), () ->
        {
            ...
            subscriptionA = clientA.addSubscription(MULTICAST_URI, STREAM_ID);
            subscriptionB = clientB.addSubscription(MULTICAST_URI, STREAM_ID);
            publication = clientA.addPublication(URI_WITH_MAX_FLOW_CONTROL, STREAM_ID);
    ...
    public void shouldSlowToTaggedWithMulticastFlowControlStrategy()
    {
        ...
        final String uriPlain = uriBuilder.build();
        final String uriWithTaggedFlowControl = uriBuilder
            .flowControl("tagged,g:" + rtag)
            .build();
        final String uriWithReceiverTag = uriBuilder
            .receiverTag(rtag)
            .build();
        ...
        assertTimeoutPreemptively(ofSeconds(20), () ->
        {
            ...
            subscriptionA = clientA.addSubscription(uriPlain, STREAM_ID);
            subscriptionB = clientB.addSubscription(uriWithReceiverTag, STREAM_ID);
