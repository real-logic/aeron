...
public class SecondsAtBitsPerSecondTest
{
    ...
    private List<RateControllerInterval> ivlsList = new ArrayList<>();
    ...
    {
        ivlsList.clear();
        ivlsList.add(new SecondsAtBitsPerSecondInterval(1, 0));
        rc = new RateController(() -> 0, ivlsList);
    }
    ...
    {
        ivlsList.clear();
        ivlsList.add(new SecondsAtBitsPerSecondInterval(0, 1));
        rc = new RateController(() -> 0, ivlsList);
    }
